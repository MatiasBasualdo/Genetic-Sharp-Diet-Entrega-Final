...
{
    public class GeneticDietPopulation : IPopulation
    {
        #region Constructors
        /// <summary>
        ...
        {
            List<EF.ChromosomeDB> lista = new EF.FoodDB().InicializarProblacion();
            ...
            AdamChromosome = new GeneticDietChromosome(lista[0]);

            for (int i = 0; i < MinSize; i++)
            {                
                var c = new GeneticDietChromosome(lista[i]);
